...
__all__ = [
    ...
    "TASK_LYRICS_SIMPLE",
    "SPOTIFY_SUNO_PROMPT_TASK",
    "SPOTIFY_SUNO_PROMPT_REWRITE_TASK",
...
# Spotify Suno prompt generation (prompt-only)
SPOTIFY_SUNO_PROMPT_SYSTEM_PROMPT = f"""\
{SPOTIFY_SUNO_PROMPT_TASK}
{SUNO_PROMPT_SPEC_V10}
"""

SPOTIFY_SUNO_PROMPT_REWRITE_PROMPT = f"""\
{SPOTIFY_SUNO_PROMPT_REWRITE_TASK}
{SUNO_PROMPT_SPEC_V10}
"""
