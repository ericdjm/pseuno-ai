...
def main() -> int:
    ...
    frontend_events: List[Tuple[str, str, Dict[str, Any]]] = [
        ...
        ("generate_clicked", "smoke_user", {"flow": "generate", "page": "new_song", "auth_state": "guest", "has_lyrics_input": True, "has_style_input": True, "personalize_enabled": False, "instrumental_intended": False, "instrumental_intent_signal": "lyrics_about_present", "flow_id": flow_id, "used_randomize_style": True, "used_randomize_lyrics": True, "primary_tag_bucket": "electronic", "tag_buckets": ["electronic"], "tags_selected": ["electronic", "synth-pop"], "tags_count": 2, "tags_recommended_count": 1, "tags_auto_picked_count": 1}),
        ("generate_succeeded", "smoke_user", {"flow": "generate", "page": "new_song", "auth_state": "guest", "duration_ms": 1234, "has_lyrics": True, "instrumental_intended": False, "instrumental_intent_signal": "lyrics_about_present", "flow_id": flow_id, "used_randomize_style": True, "used_randomize_lyrics": True, "primary_tag_bucket": "electronic", "tag_buckets": ["electronic"], "tags_selected": ["electronic", "synth-pop"], "tags_count": 2, "tags_recommended_count": 1, "tags_auto_picked_count": 1}),
        ("generate_succeeded", "smoke_user_spotify", {"flow": "generate", "page": "new_song", "auth_state": "spotify", "duration_ms": 1400, "has_lyrics": True, "instrumental_intended": True, "instrumental_intent_signal": "lyrics_about_empty", "tags_selected": ["hip-hop", "jazz", "lo-fi"], "tags_count": 3, "tags_recommended_count": 2, "tags_auto_picked_count": 1}),
